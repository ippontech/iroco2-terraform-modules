...
resource "aws_sqs_queue" "analyzer_sqs_queue" {
  name                      = "${var.namespace}-${var.project_name}-sqs-analyzer"
...
resource "aws_sqs_queue" "analyzer_deadletter" {
  name = "${var.namespace}-${var.project_name}-sqs-deadletter-analyzer"
...
resource "aws_sqs_queue" "scanner_sqs_queue" {
  name                      = "${var.namespace}-${var.project_name}-sqs-scanner"
  message_retention_seconds = 900
...
resource "aws_sqs_queue" "scanner_deadletter" {
  name = "${var.namespace}-${var.project_name}-sqs-deadletter-scanner"
...
resource "aws_sqs_queue_redrive_allow_policy" "scanner_queue_retrieve_allow_policy" {
